...
const navItems = [
  ...
  },
  {
    ...
    label: 'Investors',
    icon: Users,
    description: 'Multi-investor',
  },
  {
    href: '/fund',
    label: 'Fund',
    icon: BarChart3,
    description: 'Fund dashboard',
  },
  {
    href: '/reports',
    label: 'Reports',
  ...
  return (
    <aside className='flex flex-col w-60 shrink-0 bg-zinc-900 border-r border-zinc-800 h-screen sticky top-0'>
      ...
      <div className='flex items-center gap-2.5 px-5 py-5 border-b border-zinc-800'>
        ...
        <div>
          <p className='text-sm font-bold text-white'>Unchained</p>
          <p className='text-xs text-zinc-500'>Deal Analyzer</p>
        </div>
      </div>
