  ...
  return (
    <div className="space-y-8 font-mono text-sm" id="monthly-report">
      ...
      <div className="border-b border-zinc-700 pb-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-xs text-zinc-600 uppercase tracking-widest">Unchained OS</p>
            <p className="text-xs text-zinc-600">Private Equity Operating System</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-zinc-800 pt-4 text-xs text-zinc-600">
        <p>Report generated by Unchained OS · {now.toISOString()} · Confidential</p>
      </div>
    </div>
  )
}
...
function DealReport({ deal }: { deal: Deal }) {
  ...
  return (
    <div className="space-y-8 font-mono text-sm">
      ...
      {/* Footer */}
      <div className="border-t border-zinc-800 pt-4 text-xs text-zinc-600">
        <p>Deal Report — {deal.name} · {now.toISOString()} · Confidential — Unchained OS</p>
      </div>
    </div>
  )
}
